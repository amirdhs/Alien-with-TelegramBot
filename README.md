Here’s how you can write the README in Markdown format:
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/yourusername/Alien-with-TelegramBot
...
3. Replace the placeholder **BOT_TOKEN** in the script with your own Telegram Bot Token (obtained from [BotFather](https://core.telegram.org/bots#botfather)).
...
Feel free to fork the repository and submit issues or pull requests if you'd like to contribute to the project. All contributions are welcome!
